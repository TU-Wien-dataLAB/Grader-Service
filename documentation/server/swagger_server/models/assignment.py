...
from swagger_server.models.assignment_file import AssignmentFile  # noqa: F401,E501
from swagger_server.models.exercise import Exercise  # noqa: F401,E501
...
class Assignment(Model):
    ...
    """
    def __init__(self, id: int=None, name: str=None, exercises: List[Exercise]=None, files: List[AssignmentFile]=None, due_date: datetime=None, path: str=None, status: str=None):  # noqa: E501
        ...
        :param path: The path of this Assignment.  # noqa: E501
        :type path: str
    ...
    @exercises.setter
    def exercises(self, exercises: List[Exercise]):
    ...
    @property
    def files(self) -> List[AssignmentFile]:
    ...
    @files.setter
    def files(self, files: List[AssignmentFile]):
    ...
    @property
    def path(self) -> str:
        """Gets the path of this Assignment.


        :return: The path of this Assignment.
        :rtype: str
        """
        return self._path
    ...
    def path(self, path: str):
        """Sets the path of this Assignment.


        :param path: The path of this Assignment.
        :type path: str
        """
    ...
    def status(self, status: str):
        ...
        :type status: str
        """
        allowed_values = ["created", "released", "fetched", "submitted", "complete"]  # noqa: E501
