...
(function (InputDialog) {
  ...
  function getText(options: any) {
    return showDialog(Object.assign(Object.assign({}, options), {
      body: new InputTextDialog(options), buttons: [
  ...
  function getDate(options: any) {
    return showDialog(Object.assign(Object.assign({}, options), {
      body: new InputDateDialog(options), buttons: [
        Dialog.cancelButton({ label: options.cancelLabel }),
        Dialog.okButton({ label: options.okLabel })
      ], focusNodeSelector: 'input'
    }));
  ...
  private async createAssignment(id: number) {
    try {
      ...
      if (input.button.accept) {
        let assignment = await createAssignment(id, { "name": input.value, "due_date": null, "status": "created" }).toPromise();
