...
export function autogradeSubmission(lecture: Lecture, assignment : Assignment, student: User): Observable<Assignment> {
    return request<Assignment>(HTTPMethod.POST, `/lectures/${lecture.id}/assignments/${assignment.id}/grading/${student.name}/auto`, {}, student)
  }
...
export function getManualFeedback(lecture: Lecture, assignement : Assignment, student: User): Observable<ManualGradingContent> {
    return request<ManualGradingContent>(HTTPMethod.GET, `/lectures/${lecture.id}/assignments/${assignement.id}/grading/${student.name}/manual`, {})
  }
...
export function updateManualFeedback(lecture: Lecture, assignement : Assignment, student: User, manual: ManualGradingContent): Observable<ManualGradingContent> {
    return request<ManualGradingContent>(HTTPMethod.PUT, `/lectures/${lecture.id}/assignements/${assignement.id}/grading/${student.name}/manual`, {}, manual)
  }
