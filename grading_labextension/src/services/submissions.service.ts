...
export function submitAssignment(lecture: Lecture, assignement : Assignment): Observable<void> {
    return request<void>(HTTPMethod.POST, `/lectures/${lecture.id}/assignements/${assignement.id}/submissions`, {}, {})
  }


export function getAllSubmissions(lecture: Lecture, assignement : Assignment): Observable<Submission> {
    return request<Submission>(HTTPMethod.GET, `/lectures/${lecture.id}/assignements/${assignement.id}/submissions`, {})
  }

  export function getFeedback(lecture: Lecture, assignement : Assignment): Observable<Feedback> {
    return request<Feedback>(HTTPMethod.GET, `/lectures/${lecture.id}/assignements/${assignement.id}/feedback`, {})
  }